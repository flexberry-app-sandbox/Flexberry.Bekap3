...
namespace IIS.Bekap_3
{
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        /// материала.
        /// </summary>
        // *** Start programmer edit section *** (Товар.материала CustomAttributes)

        // *** End programmer edit section *** (Товар.материала CustomAttributes)
        public virtual int материала
        {
            get
            {
                // *** Start programmer edit section *** (Товар.материала Get start)

                // *** End programmer edit section *** (Товар.материала Get start)
                int result = this.fматериала;
                // *** Start programmer edit section *** (Товар.материала Get end)

                // *** End programmer edit section *** (Товар.материала Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Товар.материала Set start)

                // *** End programmer edit section *** (Товар.материала Set start)
                this.fматериала = value;
                // *** Start programmer edit section *** (Товар.материала Set end)

                // *** End programmer edit section *** (Товар.материала Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварE", typeof(IIS.Bekap_3.Товар));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварL", typeof(IIS.Bekap_3.Товар));
                }
            }
        }
    }
